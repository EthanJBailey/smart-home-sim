...
export default function SearchScreen() {
  ...
  const fetchDevices = async () => {
    try {
      const res = await axios.get(
        `http://146.190.130.85:8000/get-devices-by-keyword?keyword=${query}`
      );
  ...
  const handleDevicePress = (device) => {
    if (device.id !== "manual") {
      ...
      setSelectedRoom("");
      const matchingType = deviceTypes.find(
        ...
        <View style={modalStyles.overlay}>
          <View style={modalStyles.modalView}>
            ...
            <Picker
              ...
              onValueChange={(value) =>
                setNewDevice({ ...newDevice, type_id: value })
              }
              style={{
                color: "#fff",
            ...
            <Picker
              ...
              onValueChange={(value) =>
                setNewDevice({ ...newDevice, room_id: value })
              }
              style={{
                color: "#fff",
                backgroundColor: "#393535",
